[4120. Maximum Area of Two Non-Overlapping Square Submatrices](https://leetcode.com/problems/maximum-area-of-two-non-overlapping-square-submatrices)

Medium

You are given a 2D integer matrix `mat` of size `m &times; n`, where:
