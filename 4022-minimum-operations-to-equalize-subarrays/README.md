[4022. Minimum Operations to Equalize Subarrays](https://leetcode.com/problems/minimum-operations-to-equalize-subarrays)
...
**Constraints:**
	...
	* `1 <= n == nums.length <= 4 &times; 10^4`
	* `1 <= nums[i] <= 10^9`​​​​​​​
	* `1 <= k <= 10^9`
	* `1 <= queries.length <= 4 &times; 10^4`
	* `^​​​​​​​queries[i] = [li, ri]`
	* `0 <= li <= ri <= n - 1`
